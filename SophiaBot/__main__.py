...
PM_START_TEXT = """Hey there! My name is LUNA \nI can help manage your groups with useful features, feel free to add me to your groups!"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="LUNA News 🙋‍♀️ ", url=f"https://t.me/luna_officials"),
        InlineKeyboardButton(text="Support Group 💬 ", url=f"https://t.me/lunasupportz"),
    ],
    [
        InlineKeyboardButton(text="➕ Add me to your Group ➕", url="t.me/Missharelyluna_bot?startgroup=true"),   
    ],
]
...
DONATE_STRING = """ Join Updates Channel @LUNASUPPORTZ | Support Group @LUNA_officials"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Heya, luna here :) PM me if you have any questions how to use me!")
...
def sophia_about_callback(update, context):
    ...
    if query.data == "sophia_":
        query.message.edit_text(
            text=""" My name is *luna*, I have been written with Pyrogram and Telethon.. I'm online since 10 June 2021 and is constantly updated!
*Bot Version: 3.0*
\n*Bot Developers:*
-  @@Missharelyluna_bot
-  @alpha_romeo_06
\n* Updates Channel:* @lunasupportz
* Support Chat:* @luna_officials
                 ...
                 \n© 2020 - 2021 @Missharelyluna_bot. All Rights Reserved """,
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support Group", url="t.me/alpha_romeo_06"),
                    InlineKeyboardButton(text="Updates Channel", url="t.me/Missharelyluna_bot"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="sophia_basichelp"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Dihan", url="t.me/Missharelyluna_bot"),
                    InlineKeyboardButton(text="Inuka", url="t.me/alpha_romeo_06"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="sophia_basichelp"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  ...
                  [
                    InlineKeyboardButton(text="💾 Source Code", url=f"https://github.com/gprose1234gmail/SophiaBot.git"),
                 ],
                 [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "I'm Online Now! 💫 | Join my Group @lunasupportz ❤")
        except Unauthorized:
            LOGGER.warning(
                "Bot isnt able to send message to Support Group, go and check!.| Support Group @lunasupportz❤"
            )
